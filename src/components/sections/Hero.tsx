...
const PHOTOS = [
  ...
  { src: courseAi,    caption: "Where the next decade of work is being written.",         kicker: "Artificial intelligence" },
  { src: s1,          caption: "Studying from anywhere has been transformative.",         kicker: "Jacek Z. · Poland" },
  { src: courseCyber, caption: "Building the defences of a digital generation.",          kicker: "Cyber security" },
  { src: s2,          caption: "Industry-focused training that prepared me to excel.",    kicker: "Jose A. · United Kingdom" },
  { src: courseMba,   caption: "Built for the leaders of tomorrow.",                      kicker: "Business administration" },
      ...
      <div className="container-wide grid lg:grid-cols-12 gap-10 lg:gap-16 items-end">
        ...
        <div className="lg:col-span-7">
          <h1 className="font-serif text-display-xl text-ink">
            ...
            education,
            <br />
            <span className="italic-serif text-bloom">anywhere</span>
