      ...
      <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 mb-16 md:mb-20">
        ...
        <div className="lg:col-span-6 lg:col-start-7">
          <p className="font-serif text-[20px] leading-[1.55] text-ink-soft pt-2 md:pt-12">
            Every decision we make, from how a programme is built to how a
            scholarship is awarded, ladders back to the same three commitments.
            They are how we measure ourselves.
          </p>
        </div>
      </div>
