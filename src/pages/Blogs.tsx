...
const POSTS: Post[] = [
  { slug: "dba-vs-phd",       img: dba,     category: "Doctorates",    title: "DBA vs PhD in Business: which doctorate fits you?", excerpt: "A practical breakdown of how the Doctor of Business Administration compares to the PhD, and which is the right fit for your career goals.", date: "May 18, 2026", read: "8 min read" },
  { slug: "data-science-vs",  img: data,    category: "Data",          title: "Data Science vs Data Analytics: which one should you choose?", excerpt: "Two booming careers, two different mindsets. Understand the skills, tools and trajectories before you commit.", date: "May 11, 2026", read: "6 min read" },
  { slug: "diploma-levels",   img: diploma, category: "Diplomas",      title: "Level 4 vs Level 5 vs Level 7 Diploma in IT: what's the difference?", excerpt: "From foundational skills to senior strategic roles, here's what each diploma level signals to employers.", date: "May 4, 2026",  read: "5 min read" },
  { slug: "online-mba-2026",  img: dba,     category: "Business",      title: "How to choose the right online MBA in 2026", excerpt: "What accreditation, format and faculty really matter when picking an online MBA programme.", date: "April 27, 2026", read: "7 min read" },
  { slug: "ai-careers-2026",  img: data,    category: "AI",            title: "AI career paths: where to start in 2026", excerpt: "Mapping the most in-demand AI roles and the skills you'll need to land them.", date: "April 20, 2026", read: "6 min read" },
  { slug: "online-on-campus", img: diploma, category: "Recognition",   title: "Why online degrees are now equal to on-campus", excerpt: "Recognition, employer perception, and the credentials that actually move the needle.", date: "April 13, 2026", read: "4 min read" },
];
