...
const PILLARS = [
  ...
  { n: "03", title: "Progression pathways",   desc: "Our diplomas lead into full bachelor's and master's degrees, so you can build credentials step by step." },
        ...
        <div className="container-wide grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-8">
            ...
            <h2 className="mt-5 font-serif text-display text-white">
              A qualification
              <br />
              <span className="italic-serif text-bloom">that opens doors</span>
              <span className="text-ember">.</span>
            </h2>
          </div>
